...
class ApplyForRoleWithoutApprovalSimulation extends Simulation {
  ...
  val dashboardActions = new DashboardActions()
  ...
  val scn = scenario("Apply for Role without Approval")
    .exec(
      ...
      pause(4 seconds),
      dashboardActions.pressButtonAddRole,
      pause(1 second),
      dashboardActions.RoleActions.searchForRoleByName,
      pause(1 second),
      dashboardActions.RoleActions.chooseRole,
      pause(1 second),
      dashboardActions.RoleActions.enterDateAndNext,
      pause(4 second),
      dashboardActions.RoleActions.finishApply,
      pause(1 minute),
